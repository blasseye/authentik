...
If you are intentionally linking existing Homarr accounts by email during an OIDC provider migration, and the email addresses from your IdP are verified, also add `AUTH_OIDC_ENABLE_DANGEROUS_CREDENTIALS_LINKING=true`.
